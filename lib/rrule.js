...
;(function (root, factory) {
  ...
  var dateutil = {
    ...
    // The reason for replacing it in 1909 is that there is a bug in Windows7 Chrome
    // @see: https://bugs.chromium.org/p/chromium/issues/detail?id=849724
    ORDINAL_BASE: new Date(1909, 0, 1),
